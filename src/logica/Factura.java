...
public class Factura {
    ...
    public boolean agregar(int cantidad, Producto p){
        ...
        generarFacturaComision(cantidad,p);
    ...
    private void generarFacturaComision(int cantidad, Producto p) {
   
     for(ComisionProducto cp : p.getComisiones()) {
     
         if(cp.perteneceProducto(p)){
         
             cp.crearComisionVentaProducto(p, this, cantidad);
