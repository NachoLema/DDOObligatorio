...
public class Producto {
   ...
   // private int stock;
    ...
    private int codigo;
    private ArrayList<ComisionProducto> comisionesProducto = new ArrayList<ComisionProducto>() ;
    ...
    public void agregarComision(ComisionProducto  c){
    if(c!=null){
    
        comisionesProducto.add(c);
    ...
    public ArrayList<ComisionProducto> getComisiones(){
